...
COPY conf/prod/log4j2.xml $SPARK_HOME/conf
CMD ["./bin/spark-submit", "--master", "local[2]", "--packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.3.0,org.apache.spark:spark-sql_2.12:3.3.0,org.slf4j:slf4j-nop:2.0.5,org.postgresql:postgresql:42.3.3", "--jars", "/opt/bitnami/spark/postgresql-42.3.3.jar", "--driver-class-path", "postgresql-42.3.3.jar", "--class", "io.github.malyszaryczlowiek.SparkStreamingAnalyser", "/opt/bitnami/spark/SparkStreamingAnalyser-0.1.0.jar", "1000"]
...
# "--jars", "postgresql-42.3.3.jar"
# CMD ["./bin/spark-submit", "--master", "local[2]", "--packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.3.0,org.apache.spark:spark-sql_2.12:3.3.0,org.slf4j:slf4j-nop:2.0.5,org.postgresql:postgresql:42.3.3", "--class", "io.github.malyszaryczlowiek.SparkStreamingAnalyser", "/opt/bitnami/spark/SparkStreamingAnalyser-0.1.0.jar", "1000"]
# CMD ["./bin/spark-submit", "--master", "local[2]", "--packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.3.0,org.apache.spark:spark-sql_2.12:3.3.0,org.slf4j:slf4j-nop:2.0.5", "--class", "io.github.malyszaryczlowiek.SparkStreamingAnalyser", "--driver-class-path", "postgresql-42.3.3.jar", "--jars", "postgresql-42.3.3.jar", "/opt/bitnami/spark/SparkStreamingAnalyser-0.1.0.jar", "1000"]
